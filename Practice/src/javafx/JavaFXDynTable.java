...
import javafx.JavaFXDynTable.Record;
...
public class JavaFXDynTable extends Application {
	...
	static final String Day[] = { "Monday", "Tuesday", "Wednesday", "Thursday", "Friday" };
	...
	EventHandler<ActionEvent> btnNewHandler = new EventHandler<ActionEvent>() {
		...
		public void handle(ActionEvent t) {
			...
			int newId = data.size();
			Record newRec = new Record(newId, random.nextInt(100), random.nextInt(100), random.nextInt(100),
